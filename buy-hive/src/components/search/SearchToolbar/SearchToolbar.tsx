...
export function SearchToolbar({ view, onViewChange }: SearchToolbarProps) {
  ...
  return (
    ...
    >
      <Stack direction="row" spacing={2} sx={{ alignItems: "center" }} className="view-controls">
        <IconButton
      ...
      <Stack direction="row" spacing={1.5} sx={{ alignItems: "center" }}>
        ...
        <IconButton className="pagination-arrow">
          <ArrowBackIosNew />
        </IconButton>
        <Chip label="1" className="page-chip" />
        <Typography>of 22</Typography>
        <IconButton className="pagination-arrow">
          <ArrowForwardIos />
        </IconButton>
      </Stack>
